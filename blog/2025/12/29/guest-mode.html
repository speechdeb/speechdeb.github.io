  ...
  <main class="blog-layout">
    <div id="supportPopup">
      ...
      <ul>
        ...
        <li>Speechdeb will be unable to restore any deleted Guest Mode speeches.</li>
      </ul>
      ...
      <img src="/blog/assets/guest-mode/example.png" class="blog-image" alt="Guest mode example">
    </div>
  </main>
</body>
</html>
